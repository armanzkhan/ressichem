/**
 * Dry Mortar Division SRS — QC Hub product modules, categories, and parameter definitions.
 * Single source of truth for backend validation and Power BI export field mapping.
 */
...
const PACKAGING_MATERIAL_TYPES = ["Printed Bags", "Labels", "Cartons", "Pallets", "Stretch Film"];

const TREND_PARAMETERS = [
  "bulkDensity",
  "waterDemand",
  "tensileAdhesionInitial",
  "tensileAdhesionWaterImmersion",
  "tensileAdhesionHeatAging",
  "tensileAdhesionFreezeThaw",
  "waterRetention",
  "compressiveStrength",
  "flexuralStrength",
  "slip",
...
function getModuleByKey(key) {
  return QC_MODULES[key] || null;
}

function getModuleBySlug(slug) {
  return Object.values(QC_MODULES).find((m) => m.slug === slug) || null;
}
